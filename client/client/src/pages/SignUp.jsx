      ...
      <div className="w-full max-w-4xl mx-4">
        <div className="bg-white rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
          ...
          <div className="bg-gradient-to-br from-purple-600 to-indigo-700 p-10 text-white md:w-1/2 flex flex-col justify-between order-2 md:order-1">
            <div>
              <h1 className="text-3xl font-bold mb-2">10xCoders</h1>
              <p className="text-purple-200 mb-8">Join our Coding Community today</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <p>Resources and Career advice</p>
              </div>
            ...
            <div className="mt-8">
              <p className="text-sm text-purple-200">© 2025 10xCoders. All rights reserved.</p>
            </div>
          </div>
          ...
          <div className="p-10 md:w-1/2 order-1 md:order-2">
            <div className="mb-8">
              ...
              <p className="text-gray-500 mt-2">Join 10xCoders to start your Coding journey</p>
            </div>
