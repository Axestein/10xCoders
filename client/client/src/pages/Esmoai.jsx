                ...
                >
                  ...
                  {formattedSegments.map((segment, segmentIndex) => {
                    ...
                    if (segment.type === 'text') {
                      ...
                      return (
                        <div key={segmentKey} className="my-4 rounded overflow-hidden">
                          <div className="bg-gray-800 text-white p-2 flex justify-between items-center">
                            <span className="text-sm">{segment.language}</span>
                            <button 
                              onClick={() => copyToClipboard(segment.content, segmentKey)}
